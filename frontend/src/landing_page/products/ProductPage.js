...
function ProductPage() {
    return ( 
        <>
            ...
            <RightSection productName="Console" productDescription="The central dashboard for your Finora account. Gain insights into your trades and investments with in-depth reports and visualisations." learnMore="" imageUrl="media/console.png"/>
